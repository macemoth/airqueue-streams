...
public class MoodTopology {
        ...
        public static Topology buildTopology() {
                ...
                KStream<String, AirportDelay> delays = builder.stream("airport-delay",
                                Consumed.with(Serdes.String(), JsonSerdes.AirportDelay()));

                Initializer<Prediction> predictionInitializer = Prediction::new;

                Aggregator<String, AirportDelay, Prediction> predictionAggregator = (key, value, aggregate) -> aggregate
                                .add(value);
                ...
                KTable<String, Double> predictions = delays
                                ...
                                .mapValues(
                                                ...
                                                Materialized.<String, Double, KeyValueStore<Bytes, byte[]>>as("mood")
